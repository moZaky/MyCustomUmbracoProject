...
const viteLogo = "/assets/vite.png";
/**
...
const useFetch = ({ url, options, runOnFirstRender = true }) => {
  ...
  const runQuery = reactExports.useCallback((params) => {
    if (url) {
      fetchData(url);
    }
  }, [url]);
  const fetchData = async (url2, params) => {
    dispatch({ type: "loading" });
    debugger;
    if (cache.current[url2]) {
      dispatch({ type: "fetched", payload: cache.current[url2] });
      return;
    }
    try {
  ...
  return { data: state.data, loading: state.loading, error: state.error, runQuery };
};
const Home = () => {
  const {
    data: items,
    ...
    //runQuery,
    loading
  } = useFetch({ url: "/reactcontent/get" });
  reactExports.useEffect(() => {
  }, []);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h2", { children: "Homepage content" }),
    loading && /* @__PURE__ */ jsx("p", { children: "loading..." }),
    error && /* @__PURE__ */ jsxs("p", { className: "error", children: [
      "error ...",
      error == null ? void 0 : error.message
    ] }),
    !loading && items && /* @__PURE__ */ jsxs("div", { children: [
      items.title,
      /* @__PURE__ */ jsx("div", { children: items.imageUrl && /* @__PURE__ */ jsx(
        "img",
        {
          title: items.title,
          src: `${items.imageUrl}`,
...
const About = () => {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("h4", { children: "ABout a6a Us Works" }) });
};
const ContactUs = () => {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("h4", { children: "Contact 1111111 Us Works" }) });
};
const NotFound = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { children: "Page not found" }),
    /* @__PURE__ */ jsx("p", { children: "Sorry, we couldn't find the page you were looking for." })
  ] });
};
const App$1 = "";
const App = () => {
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("a", { href: "https://reactjs.org", target: "_blank", children: /* @__PURE__ */ jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsx("h1", { children: "Vite + React + Umbraco" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "card" })
  ] });
};
const index = "";
